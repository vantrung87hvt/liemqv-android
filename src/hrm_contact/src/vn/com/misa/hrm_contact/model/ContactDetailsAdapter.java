...
public class ContactDetailsAdapter extends ArrayAdapter<ContactDetails> {
	private ArrayList<ContactDetails> arrContactDetails;
	Activity context;
	ContactDetails objContactDetails;
	
	
    public ContactDetailsAdapter(Activity context, int textViewResourceId, ArrayList<ContactDetails> _arrlContactDetails) {
